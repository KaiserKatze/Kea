  ...
  private:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_ENABLE_RECONFIGURATION = 304,
        TOKEN_SUBNET6 = 305,
        ...
        TOKEN_PD_POOLS = 319,
        TOKEN_PREFIX = 320,
        TOKEN_PREFIX_LEN = 321,
        TOKEN_EXCLUDED_PREFIX = 322,
        TOKEN_EXCLUDED_PREFIX_LEN = 323,
        TOKEN_DELEGATED_LEN = 324,
        ...
        TOKEN_MAC_SOURCES = 338,
        TOKEN_RELAY_SUPPLIED_OPTIONS = 339,
        TOKEN_HOST_RESERVATION_IDENTIFIERS = 340,
        TOKEN_SANITY_CHECKS = 341,
        TOKEN_LEASE_CHECKS = 342,
        ...
        TOKEN_EN = 369,
        TOKEN_LL = 370,
        TOKEN_IDENTIFIER = 371,
        TOKEN_HTYPE = 372,
        TOKEN_TIME = 373,
        TOKEN_ENTERPRISE_ID = 374,
        ...
        TOKEN_TOPLEVEL_DHCP6 = 416,
        TOKEN_SUB_DHCP6 = 417,
        TOKEN_SUB_INTERFACES6 = 418,
        TOKEN_SUB_SUBNET6 = 419,
        TOKEN_SUB_POOL6 = 420,
        TOKEN_SUB_PD_POOL = 421,
...
switch (yytype)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_ENABLE_RECONFIGURATION (location_type l)
      {
        return symbol_type (token::TOKEN_ENABLE_RECONFIGURATION, std::move (l));
      }
#else
      static
      symbol_type
      make_ENABLE_RECONFIGURATION (const location_type& l)
      {
        return symbol_type (token::TOKEN_ENABLE_RECONFIGURATION, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 1043,     ///< Last index in yytable_.
      yynnts_ = 397,  ///< Number of nonterminal symbols.
...
#line 4228 "dhcp6_parser.h" // lalr1.cc:401
