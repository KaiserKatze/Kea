...
switch (yytype)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_DEFAULT_PREFERRED_LIFETIME (location_type l)
      {
        return symbol_type (token::TOKEN_DEFAULT_PREFERRED_LIFETIME, std::move (l));
      }
#else
      static
      symbol_type
      make_DEFAULT_PREFERRED_LIFETIME (const location_type& l)
      {
        return symbol_type (token::TOKEN_DEFAULT_PREFERRED_LIFETIME, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_DEFAULT_VALID_LIFETIME (location_type l)
      {
        return symbol_type (token::TOKEN_DEFAULT_VALID_LIFETIME, std::move (l));
      }
#else
      static
      symbol_type
      make_DEFAULT_VALID_LIFETIME (const location_type& l)
      {
        return symbol_type (token::TOKEN_DEFAULT_VALID_LIFETIME, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 1118,     ///< Last index in yytable_.
...
#line 4358 "dhcp6_parser.h" // lalr1.cc:401
