...
/**
 ** \file slaac_parser.h
 ** Define the isc::slaac::parser class.
 */
...
#ifndef YY_SLAAC_SLAAC_PARSER_H_INCLUDED
# define YY_SLAAC_SLAAC_PARSER_H_INCLUDED
// //                    "%code requires" blocks.
#line 17 "slaac_parser.yy" // lalr1.cc:401
...
#line 59 "slaac_parser.h" // lalr1.cc:401
...
#  else
#   define SLAAC_DEBUG 0
#  endif
# else /* ! defined YYDEBUG */
#  define SLAAC_DEBUG 1
# endif /* ! defined YYDEBUG */
#endif  /* ! defined SLAAC_DEBUG */

#line 14 "slaac_parser.yy" // lalr1.cc:401
namespace isc { namespace slaac {
#line 183 "slaac_parser.h" // lalr1.cc:401
  ...
  private:
...
#else
    typedef SLAAC_STYPE semantic_type;
#endif
    /// Symbol locations.
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_START_SLAAC = 295,
        TOKEN_START_SUB_SLAAC = 296,
        TOKEN_STRING = 297,
        TOKEN_INTEGER = 298,
        TOKEN_FLOAT = 299,
        TOKEN_BOOLEAN = 300
...
switch (yytype)
    ...
    SlaacParser (isc::slaac::ParserContext& ctx_yyarg);
    virtual ~SlaacParser ();
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_SLAAC (location_type l)
      {
        return symbol_type (token::TOKEN_SLAAC, std::move (l));
      }
#else
      static
      symbol_type
      make_SLAAC (const location_type& l)
      {
        return symbol_type (token::TOKEN_SLAAC, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_START_SLAAC (location_type l)
      {
        return symbol_type (token::TOKEN_START_SLAAC, std::move (l));
      }
#else
      static
      symbol_type
      make_START_SLAAC (const location_type& l)
      {
        return symbol_type (token::TOKEN_START_SLAAC, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_START_SUB_SLAAC (location_type l)
      {
        return symbol_type (token::TOKEN_START_SUB_SLAAC, std::move (l));
      }
#else
      static
      symbol_type
      make_START_SUB_SLAAC (const location_type& l)
      {
        return symbol_type (token::TOKEN_START_SUB_SLAAC, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
  ...
  private:
    ...
    SlaacParser (const SlaacParser&);
    SlaacParser& operator= (const SlaacParser&);
  ...
  private:
    ...
    // User arguments.
    isc::slaac::ParserContext& ctx;
  };

  inline
  SlaacParser::token_number_type
  SlaacParser::yytranslate_ (token_type t)
  {
...
#if 201103L <= YY_CPLUSPLUS
  template <typename Base>
  SlaacParser::basic_symbol<Base>::basic_symbol (basic_symbol&& that)
    : Base (std::move (that))
    , value ()
  ...
  template <typename Base>
  SlaacParser::basic_symbol<Base>::basic_symbol (const basic_symbol& that)
    : Base (that)
    , value ()
  ...
  template <typename Base>
  bool
  SlaacParser::basic_symbol<Base>::empty () const YY_NOEXCEPT
  {
  ...
  template <typename Base>
  void
  SlaacParser::basic_symbol<Base>::move (basic_symbol& s)
  {
    super_type::move (s);
    switch (this->type_get ())
    {
  ...
  // by_type.
  inline
  SlaacParser::by_type::by_type ()
    : type (empty_symbol)
  {}

#if 201103L <= YY_CPLUSPLUS
  inline
  SlaacParser::by_type::by_type (by_type&& that)
    : type (that.type)
  {
    that.clear ();
  }
  ...
  inline
  SlaacParser::by_type::by_type (const by_type& that)
    : type (that.type)
  {}

  inline
  SlaacParser::by_type::by_type (token_type t)
    : type (yytranslate_ (t))
  {}

  inline
  void
  SlaacParser::by_type::clear ()
  {
    type = empty_symbol;
  }
  ...
  inline
  void
  SlaacParser::by_type::move (by_type& that)
  {
    type = that.type;
    that.clear ();
  }
  ...
  inline
  int
  SlaacParser::by_type::type_get () const YY_NOEXCEPT
  {
    return type;
  }

  inline
  SlaacParser::token_type
  SlaacParser::by_type::token () const YY_NOEXCEPT
  {
...
#line 2048 "slaac_parser.h" // lalr1.cc:401




#endif // !YY_SLAAC_SLAAC_PARSER_H_INCLUDED
