  ...
  private:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_DEFAULT_VALID_LIFETIME = 312,
...
#line 4217 "dhcp4_parser.h" // lalr1.cc:401
